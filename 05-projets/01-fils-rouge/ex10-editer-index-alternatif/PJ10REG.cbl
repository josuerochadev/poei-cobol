      ...
      *---------------------------------------------------------
       ...
       FILE-CONTROL.
           SELECT F-CLIENT ASSIGN TO FCLIENT
               ...
               ALTERNATE RECORD KEY IS CLI-CODE-REGION
                   WITH DUPLICATES
      ...
      * ZONE DE RUPTURE
       01 WS-REGION-PREC           PIC 9(02) VALUE 99.
      ...
      * POSITIONNER SUR L'AIX REGION
           START F-CLIENT KEY IS >= CLI-CODE-REGION
       ...
       GERER-RUPTURE.
           MOVE 1 TO WS-AVANCE
      * RUPTURE REGION
           IF CLI-CODE-REGION NOT = WS-REGION-PREC
               IF WS-PREM = 0
                   MOVE 3 TO WS-AVANCE
               END-IF
               MOVE CLI-CODE-REGION TO WS-REGION-PREC
           END-IF
           MOVE 0 TO WS-PREM.
