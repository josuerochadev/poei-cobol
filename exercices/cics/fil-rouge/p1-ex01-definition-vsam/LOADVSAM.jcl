...
//*****************************************************************
//*
//* ETAPE 1 : CREER FICHIER SEQUENTIEL TEMPORAIRE (LRECL=64)
//*
//STEP1    EXEC PGM=IEBGENER
//SYSPRINT DD SYSOUT=*
//SYSUT2   DD DSN=&&TEMPFILE,DISP=(NEW,PASS),
//            UNIT=SYSDA,SPACE=(TRK,(1,1)),
//            DCB=(LRECL=64,BLKSIZE=640,RECFM=FB)
//SYSIN    DD DUMMY
//SYSUT1   DD *
...
/*
//*
//* ETAPE 2 : REPRO VERS VSAM
//*
//STEP2    EXEC PGM=IDCAMS
//SYSPRINT DD SYSOUT=*
//INFILE   DD DSN=&&TEMPFILE,DISP=(OLD,DELETE)
//SYSIN    DD *
 REPRO INFILE(INFILE) -
       OUTDATASET(ROCHA.CICS.CLIENT)
/*
//*
//* ETAPE 3 : VERIFICATION DU CHARGEMENT (PRINT)
//*
...
/*
//*
//* ETAPE 4 : COMPTAGE DES ENREGISTREMENTS
//*
