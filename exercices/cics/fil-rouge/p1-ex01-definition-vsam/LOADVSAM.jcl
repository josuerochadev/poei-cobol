...
//*
//* Structure enregistrement (64 octets) :
//*   Pos 01-06 : Numero compte (cle)
//*   Pos 07-08 : Code region
//*   Pos 09-10 : Nature compte
//*   Pos 11-20 : Nom client
//*   Pos 21-30 : Prenom client
...
//*
//* Donnees chargees :
//*   - 10 clients de base (000001-000010) pour tests CRUD
//*   - 5 clients 222xxx pour exercice 18 (READNEXT)
//*
//* Les clients 111xxx, 444xxx, 777xxx seront crees via
//* la transaction AJOU dans l'exercice 16.
//*****************************************************************
//*
...
//SYSIN    DD *
  REPRO INFILE(INFILE) -
        OUTDATASET(ROCHA.FINANCE.CLIENT)
/*
//*
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
  PRINT INDATASET(ROCHA.FINANCE.CLIENT) -
        CHARACTER
/*
//*
