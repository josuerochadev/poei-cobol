      ...
      *
      * Fonctionnement :
      *   1. READ avec UPDATE pour verrouiller l'enregistrement
      *   2. DELETE pour supprimer
      ******************************************************************
       ...
       0000-MAIN.
      *--- Cle a supprimer (test avec EMP099 cree par PROGWRIT)
      ...
      *--- Lecture avec verrouillage (UPDATE)
           ...
           IF WS-RESP NOT = DFHRESP(NORMAL)
               MOVE 'ERREUR: EMP099 NON TROUVE - RIEN A SUPPRIMER'
                   TO WS-MSG
               EXEC CICS SEND TEXT
                   FROM(WS-MSG)
                   LENGTH(60)
