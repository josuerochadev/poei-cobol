       ...
       PROGRAM-ID. C11CLIASC.
       AUTHOR. FORMATION COBOL.
      ******************************************************************
      * PROGRAMME : C11-CLIENT-TRI-ASC
      * OBJET     : Exercice 1 - TRI ASCENDING sur ID-CLIENT (cle)
      ...
      ******************************************************************
       0000-PRINCIPAL.
           DISPLAY '=================================================='
           DISPLAY '  EXERCICE 1 : TRI ASCENDING SUR ID-CLIENT        '
      ...
      *    Tri ASCENDING sur la cle ID-CLIENT
           DISPLAY ' '
           DISPLAY '--- Execution du SORT ASCENDING KEY TRI-ID ---'
           SORT F-TRI
      ...
      *    Afficher le fichier apres tri
           DISPLAY ' '
           DISPLAY '--- Fichier APRES tri (ASCENDING) ---'
           PERFORM 2000-AFFICHER-FICHIER-SORTIE

           DISPLAY ' '
           DISPLAY 'Fichier trie : CLIENT-TRI-ASC.PS'
